...
/
&Process
  in_file="/project/s83c/rz+/icon_data_processing_incubator/data/SWISS/lfff00000000c.ch"
  out_type="INCORE" /
...
&Process
  in_file="/project/s83c/rz+/icon_data_processing_incubator/data/SWISS/lfff<DDHH>0000.ch"
  out_file="<HH>_hzerocl.nc", out_type="NETCDF"
  tstart=0, tstop=0, tincr=1
/
